...
from share_dilution_info import get_yoy_dilution, print_dilution_summary
...
def main():
    while True:
        ...
        try:
            ...
            share_dilution_info = get_yoy_dilution(ticker_symbol)
            if share_dilution_info is not None:
                print ("========================YOY SHARE DILUTION INFO =================================")
                print_dilution_summary(share_dilution_info, ticker_symbol)               
